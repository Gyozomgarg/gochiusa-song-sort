...
getSortCompletedMessage = (date, timeTaken) => `This sorter was completed on ${date} and took ${msToReadableTime(timeTaken)}. `;

DO_ANOTHER_SORTER = 'Do another sorter?';

IN_PROGRESS_TEXT = 'You may click Load Progress after this to resume, or use this URL.';
FINISHED_TEXT = 'You may use this URL to share this result, or click Load Last Result to view it again.';
