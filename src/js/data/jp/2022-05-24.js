...
dataSet[dataSetVersion].options = [
  {
    name: "キャラクターで絞り込む",
    key: "character",
    tooltip: "特定のキャラクターに制限する場合は、これらをチェックしてください。",
    checked: false,
    sub: [
      { name: "ココア", key: "cocoa" },
      { name: "チノ", key: "chino" },
  ...
  },
  {
    name: "サブグループで絞り込む",
    key: "subgroup",
    tooltip: "特定のサブグループに制限する場合は、これらをチェックしてください。",
    checked: false,
    sub: [
  ...
  // },
  {
    name: "グループ曲で絞り込み",
    key: "group-song",
    tooltip: "複数の歌手が参加している楽曲を絞り込みたい場合は、チェックしてください。",
    checked: false
  },
  {
    name: "カバー曲で絞り込み",
    key: "cover-ver",
    tooltip: "カバー曲の絞り込みはこちらをチェックしてください。",
    checked: true,
  },
  {
    name: "リアレンジ曲で絞り込み",
    key: "rearrange-ver",
    tooltip: "リアレンジ曲の絞り込みはこちらをチェックしてください。",
    checked: true,
  },
  {
    name: "ソロ曲で絞り込み",
    key: "solo-ver",
    tooltip: "グループ曲のソロバージョンを絞り込みたい場合は、こちらをチェックしてください。",
    checked: true,
  }
];
